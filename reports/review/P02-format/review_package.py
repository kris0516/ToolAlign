"""Review new archives and a fresh, default-wheel CPU installation independently."""
...
def check_installed(args):
    ...
    from toolalign.model_io import (
        encode_action, format_descriptor, format_identity, pad_sequence,
        prompt_messages, training_sequence, validate_model_input,
    )
