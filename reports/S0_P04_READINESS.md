...
2026-09-06；S0。**准备与格式决策记录，P04尚未派发或授权训练。** P03已在29a5e4c合并并完成CPU主干验收，见[证据](S0_P03_MAIN_VERIFICATION.md)。P01修复复审与集成、P02人工语义抽查及新格式实现/配置绑定仍待完成。本记录没有改变原数据、训练选择、依赖、运行预算或冻结协议；以下旧长度与旧格式证据保留其历史范围。
