...
最新ADR-0023：kris退出全部后续人工审核，独立Q1接管语义/token-mask、P05偏好及最终讲解材料检查，R1继续技术独立复核。第1–4次同问题修订未通过由S0自主整改，第5次才整体暂停并通知kris介入；以REVIEW_POLICY和S0问题台账为准。不得代签本人或虚称其已掌握知识。原费用、登录/secret与外部条款边界保持；需要额外能力时先尝试已授权替代方案。
