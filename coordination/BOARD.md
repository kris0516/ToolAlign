...
| [P04-SFT-CPU](tasks/P04_SFT_CPU_PREPARATION.md) SFT数据/collator与数值衔接 | T1 | 技术基线42eaa50、ADR-0020 | IN_PROGRESS（CPU） | 按完整e42536d原生派发、gpt-6-astra/max，新轮ACTIVE已核验；新branch/输入intake1716路径核验通过。候选/数值/人工与正式P04门槛保持 |
