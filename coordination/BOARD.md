...
| [P01](tasks/P01_HARDWARE_COMPATIBILITY.md) 本机校准与兼容 | T1 | P00 | READY_FOR_REVIEW | 修复候选ac8095f已交付、T1空闲；[Draft PR6](https://github.com/kris0516/ToolAlign/pull/6)双Python CI通过，R1-r2已按fd67511派发/活跃；原FAIL保持 |
...
| [P03](tasks/P03_EXECUTION_HARNESS.md) 工具与 oracle | E1 | P00 | IN_PROGRESS | 原79a15d9正式FAIL，审查f34f7c5/P1=2/P2=1；[Draft PR7](https://github.com/kris0516/ToolAlign/pull/7)保留。E1已按fd67511接续最终修复并核验活跃 |
...
公共跟进：[S0-SHARED-02 / PR4](https://github.com/kris0516/ToolAlign/pull/4)已VERIFIED。P02数据代码已在2ec1767合并并完成[main技术验证](../reports/S0_P02_MAIN_VERIFICATION.md)，整包/G-DATA仍待审。原生终态核验后，S0已按fd67511实际派发P01的R1-r2、E1最终修复及D1格式CPU提案，并确认三者活跃；T1空闲，仍仅两个实现。原始候选/失败/冻结人审包保持，填写副本等待kris实际记录，不签自动人审结论。
