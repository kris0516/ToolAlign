...
| [P01](tasks/P01_HARDWARE_COMPATIBILITY.md) 本机校准与兼容 | T1 | P00 | READY | P00 VERIFIED；待 S0 领取分发；NOT_RUN |
| [P02](tasks/P02_DATA_PIPELINE.md) 数据治理 | D1 | P00 | READY | P00 VERIFIED；待 S0 领取分发；NOT_RUN |
