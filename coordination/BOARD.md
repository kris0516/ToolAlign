...
| [P02-FORMAT-v1](tasks/P02_DATA_PIPELINE.md) 共用格式与序列 | D1；R1审查 | P02代码、ADR-0017 | CHANGES_REQUESTED | [Draft PR8](https://github.com/kris0516/ToolAlign/pull/8)原候选7bada2e正式FAIL/P2=1；公开review2942e56已核验/推送，839项hash及235候选文件保持；D1按c6c02a5修复ACTIVE，已按6272ad5原生同轮同步原review并收到D1确认，复审未派发 |
...
公共跟进：P01/P03均已独立审查、合并并完成主干验证，T1/E1无新任务。原7bada2e的新格式审查FAIL/P2=1，公开review2942e56已由S0按明确去敏映射核验并推送；R1原轮completed/idle已核验，尚未派发复审。D1按c6c02a5修复ACTIVE，已收到6272ad5的同轮精确公开review同步授权。新格式原8,228行与完整分母、原数据/人审材料保持；G-DATA和训练绑定仍待验收，P04未授权。
