...
| [P04-SFT-NATIVE-TOY](tasks/P04_SFT_NATIVE_TOY.md) 原生尾周期与状态绑定 | T1；后续独立R1 | CPU已验证50867c0、ADR-0021 | IN_PROGRESS | 按de86568原生派发T1并核验新轮ACTIVE；新分支/50867c0及输入intake1976路径核验通过，数值验收待完成，旧CPU失败及人工门槛保持 |
