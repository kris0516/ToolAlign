...
| [P02-QUALITY-EXCLUSION-v3](tasks/P02_QUALITY_EXCLUSION.md) 定点来源排除与材料复用 | D1 | 已验证d3e56f6；ADR-0025 | IN_PROGRESS | 按完整3e18145原生派发/ACTIVE；实际branch/intake 15,904路径/327链接通过，编码待S0放行 |
| [Q1-P02-v3-sources-r4](tasks/Q1_P02_V3_SOURCE_REVIEW.md) 两替换来源提前审核 | Q1 | 固定2来源/3目标/8原turn | IN_PROGRESS | 按完整3e18145原生派发/ACTIVE；实际branch/intake 3,506路径通过，2来源/3目标语义继续 |
...
| [P04-SFT-RUNTIME-PROPOSAL](tasks/P04_SFT_RUNTIME_PROPOSAL.md) 真实模型接口只读方案 | T1 | 已验证d3；固定10份源码/元数据 | IN_PROGRESS | 按完整8929cbb原生派发/ACTIVE；新branch/intake待交付，无生产/框架/模型运行 |
