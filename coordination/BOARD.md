...
| [P04-SFT-DATA-V3-CPU](tasks/P04_SFT_DATA_V3_CPU.md) v3数据与审阅数组衔接 | T1；R1独立审查 | 已验收48be435/G-DATA v3 | ACCEPTED（CPU技术） | 原f2f11e0对d806 PASS；S0核验96,720路径/29命令，F2关闭，原生空闲；待组合/最终CI/main，[接收](../reports/S0_P04_DATA_V3_REVIEW_R3_HANDOFF.md) |
...
| [P04-SFT-DATA-V3-FD-CLOSE-FIX](tasks/P04_SFT_DATA_V3_FD_CLOSE_FIX.md) 构造异常清理 | T1；R1独立复审 | 精确1769046/正式582 F2 | ACCEPTED（CPU技术） | 原f2f11e0对d806 PASS；S0核验96,720路径/29命令，F2关闭，原生空闲；待组合/最终CI/main，[接收](../reports/S0_P04_DATA_V3_REVIEW_R3_HANDOFF.md) |
| [P04-SFT-QWEN-RUNTIME-CPU](tasks/P04_SFT_QWEN_RUNTIME_CPU.md) 有限原生训练接口 | T1拟承接；R1独立审查 | 模型CPU主干已验收；数据CPU已独立PASS待main | PLANNED | ADR-0029精确CPU配置fa9e52b4已冻结；[准备](../reports/S0_P04_QWEN_RUNTIME_CPU_PREPARATION.md)，真实数据/编码/模型/GPU0、未派发 |
| [P04-SFT-DATA-V3-R3](tasks/P04_SFT_DATA_V3_FD_CLOSE_REVIEW.md) FD修订独立复审 | R1 | 精确d80667e/原582 F2 | ACCEPTED（CPU技术） | 原f2f11e0对d806 PASS；S0核验96,720路径/29命令，F2关闭，原生空闲；待组合/最终CI/main，[接收](../reports/S0_P04_DATA_V3_REVIEW_R3_HANDOFF.md) |
