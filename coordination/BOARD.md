...
公共跟进：[S0-SHARED-02 / PR4](https://github.com/kris0516/ToolAlign/pull/4) 首轮 `55a330b` 的嵌套文件 P1 已修，第二候选 `8148929` 又发现 Mac 大小写 P1。最新修订 `ea05131` 自测排除 241 私有探针、保留 18 公开对照，待新精确候选复审。旧 FAIL 均保留；尚未发布新基线，旧基线禁止默认源码包构建/发行，CPU实现与wheel可继续。
