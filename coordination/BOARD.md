...
| [P04-SFT-DATA-V3-NONREGULAR-FIX](tasks/P04_SFT_DATA_V3_NONREGULAR_FIX.md) 特殊文件非阻塞拒绝 | T1 | 原冻结f3b7f1a1/中间F1 | IN_PROGRESS | 按完整90ded89原生派发/新轮ACTIVE，新branch/intake待交付；R1继续审原f3b7f1a1 |
