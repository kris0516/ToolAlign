...
| [P02-QUALITY-ADJUDICATION](tasks/P02_QUALITY_ADJUDICATION.md) 裁定后新数据版本 | D1 | 已验证6c81；ADR-0024 | IN_PROGRESS | 按完整f8b81b9原生派发/ACTIVE；S0核验8,977路径及217输入intake通过 |
...
| [P02-QUALITY-AUDIT-TYPE-REVIEW](tasks/P02_QUALITY_AUDIT_TYPE_REVIEW.md) 类型修复复审 | R1 | 精确da22 | IN_PROGRESS | 按完整e8def03原生派发/ACTIVE；S0核验4,475路径intake，原9645055保持 |
