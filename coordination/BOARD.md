...
| [P02-FORMAT-v1](tasks/P02_DATA_PIPELINE.md) 共用格式与序列 | D1；R1审查 | P02代码、ADR-0017 | CHANGES_REQUESTED | [Draft PR8](https://github.com/kris0516/ToolAlign/pull/8)候选7bada2e；R1真实参考loader稳定复现同身份但编码改变，正式审查仍ACTIVE；D1按完整c6c02a5原生修复ACTIVE，未验收；原双Python CI与768CPU组合预检保持 |
...
公共跟进：P01/P03均已独立审查、合并并完成主干验证，T1/E1无新任务。R1继续审精确7bada2e，已稳定复现参考tokenizer的来源绑定缺陷；D1按完整c6c02a5原生修复ACTIVE。新格式原8,228行与完整分母、原数据/人审材料保持。kris人审原请求与填写副本保留，不代签判断；新格式及训练绑定仍待验收，P04未授权。
