...
| [P02-FORMAT-v1](tasks/P02_DATA_PIPELINE.md) 共用格式与序列 | D1；R1审查 | P02代码、ADR-0017 | READY_FOR_REVIEW | 候选7bada2e已交付/空闲；S0核验713项checksum及217份不变原文件，664CPU为D1自测；R1按完整1de9078原生派发并确认ACTIVE，未验收 |
