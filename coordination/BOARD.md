...
| [P01](tasks/P01_HARDWARE_COMPATIBILITY.md) 本机校准与兼容 | T1 | P00 | CHANGES_REQUESTED | ac8095f复审FAIL，原review aaae5a4/P1=1，F2/F3关闭；T1空闲，启动初始化CPU修复待派发；[Draft PR6](https://github.com/kris0516/ToolAlign/pull/6)保持 |
...
| [P03](tasks/P03_EXECUTION_HARNESS.md) 工具与 oracle | E1 | P00 | READY_FOR_REVIEW | 最终3598cef已交付/原生空闲，389CPU自测及双Python CI通过；原FAIL f34f7c5保留，新R1-r2范围待派发；[Draft PR7](https://github.com/kris0516/ToolAlign/pull/7)保持 |
...
公共跟进：共享包和P02数据代码主干技术验证保持。P01-r2正式FAIL原SHA aaae5a4已接收，T1初始化定点修复范围已准备；P03最终3598cef已交付并空闲，待R1结束本轮后独立复审。D1初版提案c23b513的45项hash已核对，仍在原CPU提案范围内补充角色保留方案比较，未选正式格式。人审请求保持一次待答，原100来源/114决策包及填写副本保持，不签自动人审。
