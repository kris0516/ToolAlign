...
S0隔离普通集成 `170be4295b2557953fa0349a8c5746a4fc098926` 实际973CPU/48 optional跳过、三现存归档/65安装包字节绑定通过；原psutil缓存预加载干扰导致的一次S0测试失败保留，改用默认CPU环境后相同1,021用例ID复验通过，候选未变。见[集成证据](../../reports/S0_P04_QWEN_CPU_INTEGRATION.md)；最终PR17 CI/main仍待完成。
