...
状态：VERIFIED（独立 PASS、CI、合并/main 验证通过）；owner S0；base `4cfbe1a5b8d93c20d7b11ec14b31757a574d0903`；branch `work/shared-compat-source-policy`。
...
用户 2026-09-06 明确修正 S0/子任务模型设置，本包追加 S0 所有协调文档与分发模板保护；不修改被审生产依赖/政策。R1 审查提交 8ceea3fbdd476ef0a5583e82e38473f1038dc650，候选 e4127d9a0e6e30b091cba9b9e22a5fbb7091e9a2，剩余 P0/P1/P2 为 0。

集成：PR #3 合并 18fc8475476f6becf684ba817480caeb96a7cfb9，main 233 项 CPU 检查与独立 wheel 验证全部通过；见 reports/S0_SHARED_01_MAIN_VERIFICATION.md。T1/D1 可据 S0 明确发布的新 main 基线合并公共变更，原任务范围和人工/独立审查门不变。
