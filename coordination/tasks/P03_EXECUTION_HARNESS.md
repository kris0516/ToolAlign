...
状态：CLAIMED；owner E1；code_base `97466a20f599f68c511b9c8a71fe5f2cdfd9ad4b`；branch `work/p03-execution-harness`。T1 已交付并停止，当前可与 D1 并行，最多两个实现任务。S0 派发消息给出本任务包的 authorization_commit；先读取并保存授权副本，再从 code_base 建独立分支。
