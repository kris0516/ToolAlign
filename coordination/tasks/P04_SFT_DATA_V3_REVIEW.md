...
状态：PLANNED，尚未派发。等待 T1 完整候选、实际 source/installed 证据和原生终态；candidate、code_base 和 authorization_commit 均待 S0 在接收后填入完整 SHA。本文件不允许 R1 提前审查变化中的工作区，也不增加 T1 的消费额度。
