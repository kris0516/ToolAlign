...
ADR-0025的v3定点排除范围已冻结：[D1任务](coordination/tasks/P02_QUALITY_EXCLUSION.md)含347输入，保留原选择/字节及11例旧编码，仅2例新增；[Q1提前审核](coordination/tasks/Q1_P02_V3_SOURCE_REVIEW.md)固定2来源/3目标/8turn。D1按完整3e18145继续ACTIVE，两份v3数据及11例旧材料复用已回报；Q1完整9c12c47来源PASS已正式接收/原生空闲，S0核验3,671路径/34原命令并普通整合eab828f，14:48:51 UTC已按精确放行1eeea3bd原生通知D1运行原两例编码。T1只读P04方案实际branch/intake经S0核验5,617路径/197链接，原轮继续ACTIVE；R1后续v3范围PLANNED未派发，E1无新范围。实际v3完整候选/处置/材料及R1验收仍待交付。无新增GPU或训练许可。
