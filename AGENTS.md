...
ADR-0025的v3定点排除范围已冻结：[D1任务](coordination/tasks/P02_QUALITY_EXCLUSION.md)含347输入，保留原选择/字节及11例旧编码，仅2例新增；[Q1提前审核](coordination/tasks/Q1_P02_V3_SOURCE_REVIEW.md)固定2来源/3目标/8turn。两任务已于13:55:51 UTC按完整3e18145原生派发并确认新轮ACTIVE，D1实际新branch/intake已由S0核验15,904路径/327链接，Q1实际branch/intake已核验3,506路径/16命令；T1只读P04方案实际新branch/intake经S0核验5,617路径/197链接通过、原轮继续ACTIVE，R1/E1无新范围；D1编码待S0按Q1精确结论放行，实际v3处置/材料及R1验收仍待交付。无新增GPU或训练许可。
