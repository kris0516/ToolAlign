...
P00、共享支持、P01受限兼容校准和P03 CPU任务已VERIFIED。P01在d10722e合并并完成main655CPU/21条隔离命令验证，G1-SFT与唯一DPO备选分项PASS，首选DPO FAIL保持；P03先在29a5e4c完成独立验收和主干验证。R1按完整1de9078继续独立审7bada2e，已稳定复现参考tokenizer来源绑定缺陷；D1定点修复范围已准备尚未派发，T1/E1/D1空闲。原数据和人审材料保持，尚无正式模型训练或评测验收。最多两个实现加独立CPU R1，无新GPU。P02/G-DATA仍待kris实际语义审查、新格式独立验收和训练绑定，P04尚未授权。
